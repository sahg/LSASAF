...
lat, lon = (-22.0, 14.97)
row, col = pymsg.geoloc_to_pixelloc(lat, lon, loff, coff)

# Reverse the transform
lat1, lon1 = pymsg.pixelloc_to_geoloc(row, col, loff, coff)
...
# Reverse the transform
row1, col1 = pymsg.geoloc_to_pixelloc(lat1, lon1, loff, coff)
